...
import { setupReactivity,  watchEffect } from './core/hooks/basic';
...
function shallowDiffAndPatch(parent: HTMLElement, newChildren: HTMLCollection | Element[]): void {
...
export function handleHashChange(app: HTMLElement | Document | any, routes: Route[]): void {
